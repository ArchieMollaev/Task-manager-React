...
const cardSource = {
  ...
  beginDrag(props) {
    const { dataID, position, title, description, status } = props;
      ...
      connectDragSource(
        <li>
          <div data-id={dataID} data-position={position} className={classCard}>
            <Textarea className={classTitle} type="text" value={title} readOnly />
            ...
            <Textarea className={classNote} type="text" value={description || ''} readOnly />
          ...
          <div className={injectorClass} onDragOver={injectorHoverFunc} />
        </li>
      )
    );
  };
